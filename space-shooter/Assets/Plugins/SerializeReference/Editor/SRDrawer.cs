...
public class SRDrawer : PropertyDrawer
{
	...
	private void ShowMenu(SerializedProperty property, bool applyArray)
	{
		...
		if(_attr.Types == null || _attr.Types.Length == 0)
		...
		if(types != null)
		{
			...
			foreach (var type in types)
				context.AddItem(new GUIContent(type.Path), false, OnMenuItemClick, new SRAction(property, type.Path));
		}
